...
from transformers import CLIPTextModel, CLIPTokenizer, T5Tokenizer, T5EncoderModel
...
def get_args():
    ...
    parser.add_argument('--trmodelpath', type=str, default="/root/test/opus-mt-it-en")
...
text_encoder = CLIPTextModel.from_pretrained('/root/test/mobius/text_encoder')
#text_encoder_2 = CLIPTextModel.from_pretrained(
#    sdxl_name, subfolder="text_encoder_2", torch_dtype=torch.float16, variant="fp16")
text_encoder_2 = CLIPTextModel.from_pretrained('/root/test/mobius/text_encoder_2')
#vae = AutoencoderKL.from_pretrained(
#    sdxl_name, subfolder="vae", torch_dtype=torch.bfloat16, variant="fp16")  # bfloat16 vae
vae = AutoencoderKL.from_pretrained('/root/test/mobius/vae')
#unet = UNet2DConditionModel.from_pretrained(
#    sdxl_name, subfolder="unet", torch_dtype=torch.float16, variant="fp16")
unet = UNet2DConditionModel.from_pretrained('/root/test/mobius/unet')
...
def chat_fn(message: str, history: list, seed:int, temperature: float, top_p: float, max_new_tokens: int) -> str:
    ...
    # conversation.append({"role": "user", "content": model.translate([message])[0]})
